...
class MatcherPriorityConfig(BaseModel):
    ...
    about: int = Field(default=18, ge=0)
    help: int = Field(default=17, ge=0)
    ...
    ai_intent: int = Field(default=40, ge=0)
    seer_query: int = Field(default=90, ge=0)
    seer_player: int = Field(default=5, ge=0)
    seer_team: int = Field(default=6, ge=0)
    seer_rank: int = Field(default=7, ge=0)
    seer_rank_help: int = Field(default=8, ge=0)
    seer_autocard: int = Field(default=9, ge=0)
    seer_mintmark: int = Field(default=10, ge=0)
    seer_pet: int = Field(default=11, ge=0)
    seer_type: int = Field(default=12, ge=0)
    ...
    message_commands: int = Field(default=30, ge=0)
    meeting: int = Field(default=50, ge=0)
    activity: int = Field(default=60, ge=0)
    db_sync: int = Field(default=70, ge=0)
    team_audit: int = Field(default=80, ge=0)
