...
class HelpConfig(BaseModel):
    ...
    new_command_initial_weight: float = Field(default=5.0, ge=1, allow_inf_nan=False)
    new_command_half_life_days: float = Field(default=5.0, gt=0, allow_inf_nan=False)
