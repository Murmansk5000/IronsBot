...
FEATURE_REGISTRY: FeatureModuleRegistry = {
    ...
    "bili_query": ("ironsbot.custom_plugins.bilibili_monitor",),
    "bili_push": ("ironsbot.custom_plugins.bilibili_monitor",),
    "activity_query": ("ironsbot.custom_plugins.activity_reminder",),
    "activity_push": ("ironsbot.custom_plugins.activity_reminder",),
    "server_status_query": ("ironsbot.custom_plugins.server_status",),
    "server_status_push": ("ironsbot.custom_plugins.server_status",),
    "team": ("ironsbot.custom_plugins.team_shortcut",),
    "ai_chat": ("ironsbot.custom_plugins.ai_chat",),
    "ai_intent": ("ironsbot.custom_plugins.ai_intent_actions",),
    "admin_notice": ("ironsbot.custom_plugins.ai_chat",),
}
