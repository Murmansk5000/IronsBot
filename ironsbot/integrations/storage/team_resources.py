...
from ironsbot.integrations.storage.team_resource_schema import (
    GROUP_SUBSCRIPTION_VALUE_COLUMNS,
    TEAM_RESOURCE_MIGRATION_NAMESPACE,
    ...
    def __init__(
        ...
        *,
        ...
        self._database = SqliteDatabase(
            path,
            migrations=TEAM_RESOURCE_MIGRATIONS,
            migration_namespace=TEAM_RESOURCE_MIGRATION_NAMESPACE,
        )
...
def _merge_group_subscriptions(
    ...
    columns = ", ".join(
        ("principal_kind", "principal_id", *GROUP_SUBSCRIPTION_VALUE_COLUMNS)
    )
    placeholders = ", ".join(
...
def _group_subscription_rows(
    ...
    columns = ", ".join(GROUP_SUBSCRIPTION_VALUE_COLUMNS)
    return [
        tuple(row)
