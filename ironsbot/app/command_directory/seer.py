    ...
    return (
        *commands_from_rows(
            ...
            (
                ...
                (
                    ...
                    ("米米号", "收集", "巅峰", "群星牌"),
                    (
                        "查询默认米米号的对应数据；群内 @成员 代查需先绑定默认米米号，"
                        "未绑定时在指令后填写完整米米号"
                    ),
                    {},
                ),
                (
                    "seer.player.bind",
                    (
                        "绑定米米号123456 / 绑定米米号账号别名",
                        (
                            "绑定米米号123456@成员 / "
                            "绑定米米号账号别名@成员（仅超级管理员，无改绑冷却）"
                        ),
                    ),
                    "数字或当前会话可见账号别名均可绑定；超级管理员可直接为群成员无冷却绑定",
                    {},
                ),
                (
                    "seer.player.unbind",
        ...
        *commands_from_rows(
            ...
            (
                (
                    "seer.team.query",
                    ("战队123456", "战队玩家1", "战队@成员", "战队米米号123456"),
                    "纯数字直查战队（最多3个）；米米号或别名查所属战队，@代查需先绑定",
                    {"show_in_poke": True},
                ),
            ),
        ),
