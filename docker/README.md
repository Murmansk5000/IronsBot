...
# Use the name referenced by seer.lucky_skin_window.accounts.password_env.
MUR_PASSWORD=
SENDPIC_CNB_TOKEN=
...
| Custom lucky-window password variables | Password names referenced by `password_env`; player IDs remain in TOML. These accounts use isolated short-lived sessions. |
