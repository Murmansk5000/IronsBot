...
套装/部件/称号、属性/异常状态、巅峰资料、榜单和活动查询。查询出现多个候选项时直接发送数字选择，
...
features = ["help", "about", "seer_data", "seer_player", "seer_team", "seer_pet", "seer_mintmark", "seer_equipment", "seer_type", "seer_peak", "seer_rank", "seer_activity_query", "ai_chat"]
superusers = []
```
