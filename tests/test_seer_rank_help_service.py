from ironsbot.services.seer.rank_command_contracts import rank_help_command_descriptors
...
def test_rank_command_examples_are_derived_from_rank_specs() -> None:
    commands = {
        command.id: command for command in rank_help_command_descriptors()
    }
